...
```
## Вывод
Мы написали программу, в которой создали класс с атрибутами make и model и написали комментарии к этому коду.
...
## Вывод
Мы дополнили код из первого задания, добавив атрибуты и метод drive.
...
## Вывод
Мы написали программу, в которой создали новый класс с методом и атрибутом, и реализовали наследование от самого первого созданного класса.
...
## Вывод
Мы написали программу, где создали защищенный атрибут make и приватный атрибут model. Для этого мы реализовали инкапсуляцию для класса.
...
## Вывод
Мы написали программу, которая рассчитывает площади фигур. В этой программе мы реализовали полиморфизм.
...
## Вывод
Мы написали программу, в которой создали класс animal и объект Кошка и метод sound.
...
## Вывод
Мы написали программу, в которой расширили класс animal добавив Dog и Cat и переопределили метод sound.
...
## Вывод
Мы написали программу, где реализовали наследование добавив новое животное pig.
...
## Вывод
Мы написали программу, где реализовали инкапсуляцию путем изменения названия животного.
...
## Вывод
Мы написали программу, где реализовали полиморфизм путем функции animal_sound и использовав массив с животными.

## Общий вывод по теме
В теме №8 мы изучили основные принципы ООП: как работать с классами, обьектами, методами и как их создавать, инкапсуляцию, полиморфизм, наследование.
