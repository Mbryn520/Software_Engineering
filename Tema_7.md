...
## Вывод
Мы составили текстовый файл и положили его в одну директорию с программой python дабы упростить доступ к файлу.
...
## Вывод
Мы написали программу которая выводит только первую строку из файла при помощи readline. Чтобы открыть файл при помощи программы, мы использовали open с r(чтение), а для закрытия close.
...
## Вывод
Мы написали программу, которая выводит все строки из файла при помощи readlines.
...
## Вывод
Мы написали программу, которая выводит все строки из нашего файла. Для открытия файла мы использовали конструкцию with open, которая автоматически закрывает файл.
...
## Вывод
Мы написали программу, которая выводит каждую строку из нашего файла отдельно, благодаря конструкции for line in f.
...
## Вывод
Мы написали программу, которая добавляет уже к нашему существующему файлу еще одну новую строку, для этого мы использовали a+ (добавление и чтение) и write для добавления новых данных.
...
## Вывод
Мы написали программу, которая изменяет содержимое файла новыми данными, для этого мы использовали w(перезапись) и write для добавления новых данных.
...
## Вывод
Мы написали программу, которая выводит содержимое папки со всеми вложенными директориями. Для этого мы использовали модуль os.
...
## Вывод
Мы написали функцию, которая выводит слово с максимальной длиной из файла. Для этого мы использовали read для чтения слов из файла и split для разбития на отдельные слова.
...
## Вывод
Мы написали программу, которая заполняет табличный файл csv. Для этого мы использовали модули csv и функцию writerow для записи строк в csv.
...
## Вывод
Мы написали программу, которая определяет сколько всего слов в файле и какое слово наиболее встречающееся. Для этого мы использовали counter для подсчета частот.
...
## Вывод
Мы написали программу, которая дает вводить информацию о расходах и сохранять ее в файл. Для этого мы использовали запись в режиме a(добавление).
...
## Вывод
Мы написали программу, которая подсчитывает количество букв, слов и строк. Для этого мы использовали методы isalpha и split.
...
## Вывод
Мы написали программу, которая цензурирует текст, заменяя слова на звездочки. Для этого мы использовали методы find и replace.
...
## Вывод
Мы написали программу, которая подсчитывает количество гласных в тексте в файле.

## Общий вывод по теме
В теме №7 мы изучили работу с текстовыми файлами, как их открывать для чтения, добавлять данные, перезаписывать, закрывать. Изучили различные методы чтения, такие как: read, readline и readlines.
